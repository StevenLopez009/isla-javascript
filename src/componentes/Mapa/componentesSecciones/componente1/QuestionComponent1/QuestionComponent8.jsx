    ...
    <>
      {vida > 0 && (
        <>
          ...
          {reachedEnd && (
            <div className="demon">
              <img src={demon8} alt="" className="demon-gif" />
              {!last && (
                <div className="demon_info">
                  <p className="dialogo-eight">
                    Soy Morgoth, protector de la tierra de la programación
                    orientada a objetos, resuelve mi problema a cambio, te daré
                    esta información. Tu reina fue llevada por los orcos al
                    portal asincrono ya estas a medio camino
                  </p>
                  <button
                    className="btnPlay"

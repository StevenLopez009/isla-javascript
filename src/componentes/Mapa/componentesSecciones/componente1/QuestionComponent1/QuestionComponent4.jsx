    ...
    <>
      {vida > 0 && (
        <>
          ...
          {reachedEnd && (
            <div className="demon">
              <img src={demon4} alt="" className="demon-gif" />
              {!last && (
                <div className="demon_info">
                  <p className="dialogo dialogo-four">
                    Soy Astrid, quieres rescatar a tu dulce reina estas muy
                    lejos aun, dame tus vidas y olvidala, la reina fue vendida a
                    un comprador por un buen precio si resuelves mi codigo
                    podras ir al castillo de los arreglos es a donde la llevaron
                  </p>
                  <button
                    className="btnPlay"

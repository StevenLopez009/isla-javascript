...
import demon14 from "../../../../../assets/img/demon14.gif";
import codigo14 from "../../../../../assets/img/codigo14.jpeg";
import { useEffect, useState } from "react";
import "./QuestionComponent1.css";
import useComponent from "../../../hooks/useComponent";

const QuestionComponent14 = ({ data, PasarSeccion }) => {
  const {
    currentQuestion,
    showQuestion,
    showCorrection,
        ...
        <>
          {!showQuestion && (
            <div className="clase1">
              ...
              <div className="clase2 clase-colors14">
                <img
          ...
          {reachedEnd && (
            <div className="demon">
              <img src={demon14} alt="" className="demon-gif" />
              {!last && (
                <div className="demon_info">
                  <p className="dialogo dialogo-fouteen">
                  ...
                  {showContenedor && (
                    <div className="contenedor_centrado">
                      <div className="demon_codigo">
                        <p className="dialogo-fouteen">
                          Necesito exportar esta funcion que me faltaria
                        </p>
                        <img src={codigo14} alt="" />
                        <input
                          type="text"
                          value={inputValue}
...
export default QuestionComponent14;

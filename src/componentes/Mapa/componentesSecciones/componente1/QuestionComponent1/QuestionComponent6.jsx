...
import demon6 from "../../../../../assets/img/demon6.png";
import codigo6 from "../../../../../assets/img/codigo6.jpeg";
...
const QuestionComponent6 = ({ data, PasarSeccion }) => {
  ...
  const handleButtonClick = () => {
    if (inputValue === "addEventListener") {
      setFinal(true);
        ...
        <>
          {!showQuestion && (
            <div className="clase1">
              ...
              <div className="clase2 clase-colors6">
                <img
          ...
          {reachedEnd && (
            <div className="demon">
              <img src={demon6} alt="" className="demon-gif" />
              {!last && (
                <div className="demon_info">
                  <p className="dialogo dialogo-six">
                    Soy Gravex, Golem del Dom , tu reina fue traída por un Orco
                    muy poderoso soluciono mi codigo y continuo su camino
                    pretende llevar tu reina Elfa muy lejos a travez de los
                    portales Fetch , deberas darte prisa
                  </p>
                  <button
                    className="btnPlay"
                  ...
                  {showContenedor && (
                    <div className="contenedor_centrado">
                      <div className="demon_codigo">
                        <p className="dialogo-six-last">
                          Necesito agregar el evento para el click de este boton
                        </p>
                        <img src={codigo6} alt="" />
                        <input
                          type="text"
...
export default QuestionComponent6;
